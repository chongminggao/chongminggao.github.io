...
\familyname{Gao)
% \\\vspace{3mm}
% \LARGE{HomePage: ~ https://chongminggao.com}
} % Your last name
...
\homepage{https://chongminggao.com}%{staff.org.edu/$f$jsmith}% The first argument is %the url for the clickable link, the second argument is the url displayed in the %template - this allows special characters to be displayed such as the tilde in this %example
